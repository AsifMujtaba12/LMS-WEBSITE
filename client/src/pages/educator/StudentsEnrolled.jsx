...
const StudentsEnrolled = () => {
  ...
  return enrolledStudents ?(
    <div className='min-h-screen flex flex-col items-center justify-between md:p-8
    md:pb-0 p-4 pt-8 pb-0'>
     <div className='flexflex-col items-center max-w-4xl w-full overflow-hidden rounded-md 
